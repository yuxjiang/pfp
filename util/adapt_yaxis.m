function [ylim, ts] = adapt_yaxis(olim, tlim, cts)
    ...
    %
    % [double]
    % cts:  A vector of candidate tick steps E.g. [0.1 0.2 0.5 1.0 1.5]
    %
    % Output
    % ------
    % [double]
    % ylim: The [lower, upper] bound of y-axis. Note that 'ylim' can be used to
    %       set 'axes.YLim'
    %
    % [double]
    % ts:   The tick step.
...
% Last modified: Wed 21 Sep 2016 02:26:05 PM E
