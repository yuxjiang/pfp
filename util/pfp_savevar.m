function [] = pfp_savevar(ofile, vardata, varname)
    ...
    % (optional)
    % [char]
    % varname:  Assign a new name to the saved variable if needed. It resort to
    %           inputname(vardata) if not given or given as empty.
    %           default: ''
    %
    % Output
    % ------
...
% Last modified: Wed 21 Sep 2016 02:39:01 PM E
