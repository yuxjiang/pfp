function [blast] = pfp_importblastp(ifile, ksh)
    ...
    % 2. If 'ksh' is set to false, sequences that have only self-hits are
    %    removed.
    %
    % Input
    % -----
    ...
    %                                matches.
    %               .nident [double] A k-by-1 array of numbers of identical
    %                                matches.
...
% Last modified: Wed 21 Sep 2016 02:32:57 PM E
