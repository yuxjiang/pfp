function [pred] = pfp_predprop(pred, force, scheme)
    ...
    %           'max'   - The score of a parent term is set to the maximum of
    %                     those of its children (and itself).
    %           'ind'   - The score of a parent 's' is
    %           (TBA)     s = 1 - \prod_i{1 - s_i}
    %                     where s_i is the score of its i-th child. It Assumes
    %                     scores are probabilities and scores of its children
...
% Last modified: Wed 21 Sep 2016 12:56:07 PM E
