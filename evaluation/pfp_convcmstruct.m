function [res] = pfp_convcmstruct(cmstruct, metric, varargin)
    ...
    %
    %   Converts a confusion matrix struct (returned from pfp_seqcm.m) to a
    %   specific confusion matrix derived metric (e.g. precision-recall curve).
    %
    % Input
    % -----
    % (required)
    ...
    %                         corresponding object is predicted ("covered") by
    %                         the model.
...
% Last modified: Wed 21 Sep 2016 01:26:50 PM E
