function [cm] = pfp_termcm(target, pred, oa, evmode, varargin)
    ...
    %
    %   Calculate term-centric confusion matrices. It computes k matrices for
    ...
    %       .npp     [double] An 1-by-m array of number of positive predictions
    %                         for each term.
...
% Last modified: Wed 21 Sep 2016 01:44:30 PM E
