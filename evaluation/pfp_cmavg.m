function [m] = pfp_cmavg(cmstruct, metric, varargin)
    ...
    %           'acc' - accuracy
    %
    %         * Note: starred (*) metrics are only available in
    %           "sequence-centered" evaluation. Since information accretion
    %           makes no sense in "term-centered" evaluation model.
    %
...
% Last modified: Wed 21 Sep 2016 01:24:42 PM E
