function [m] = pfp_seqmetric(target, pred, oa, metric, varargin)
    ...
    %
    % [double]
    % 'w'       A weight vector over terms. Note that an empty vector implies
    %           equal weights.
    %           default: []
    %
    % [double]
    ...
    %           evaluation, i.e., returned by pfp_seqcm.m rather than
    %           pfp_termcm.m. (indeed, 'evmode' has to be decided when calling
    %           pfp_termcm.m)
...
% Last modified: Wed 21 Sep 2016 01:41:56 PM E
