function [m] = pfp_cmmetric(cm, metric, varargin)
    ...
    %         Note that each row of cm construct a confusion matrix, and they
    ...
    % ------
    % [double]
    % m:    The resulting metric with the size n-by-1 or n-by-2 depending on
    %       'metric'.
    %
    % See Also
    % --------
...
% Last modified: Wed 21 Sep 2016 01:25:24 PM E
